...
(custom-set-variables
 ...
 '(package-selected-packages
   '(magit company-terraform terraform-doc evil-paredit evil-python-movement golden-ratio toml-mode company-lsp company-racer helm-lsp lsp-mode coffee-mode htmlize emojify company-emoji emoji-cheat-sheet-plus emoji-display py-autopep8 deadgrep helm-rg projectile-ripgrep rg ripgrep company-web emmet-mode clang-format fireplace flycheck-rust flymake-rust tidal gdscript-mode hydra flycheck flycheck-clang-analyzer flycheck-pony helm-core flymake-cursor rainbow-delimiters yasnippet yapfify rust-playground racket-mode racer quack pyvenv python-docstring python-django pylint powerline-evil pony-mode paredit nasm-mode mustang-theme moe-theme markdown-mode+ magit-find-file iasm-mode helm-gtags helm-cscope gh-md ggtags flymd exec-path-from-shell evil-smartparens doom-themes dockerfile-mode docker-compose-mode docker cyberpunk-theme company-anaconda cargo busybee-theme ac-geiser))
 '(pyvenv-mode t)
 '(show-paren-mode t)
 '(tool-bar-mode nil)
