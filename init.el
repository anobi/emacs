...
(custom-set-variables
 ...
 '(embark-consult consult embark marginalia orderless vertico yasnippet toml-mode slime rust-playground racket-mode poetry paredit nimbus-theme lsp-pyright haskell-mode ggtags geiser flycheck-rust exec-path-from-shell evil doom-themes cargo))
 '(pyvenv-mode t)
 '(show-paren-mode t)
 '(tool-bar-mode nil)
